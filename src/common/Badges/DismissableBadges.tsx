...
export const DismissableBadges = () => {
    return (<>
        ...
        <span
          ...
          className="inline-flex items-center py-1 px-2 mr-2 text-sm font-medium text-gray-800 bg-gray-100 rounded dark:bg-gray-200 dark:text-gray-800"
        >
          Dark
          <button
            type="button"
        ...
        <span
          ...
          className="inline-flex items-center py-1 px-2 mr-2 text-sm font-medium text-red-800 bg-red-100 rounded dark:bg-red-200 dark:text-red-800"
        >
          Red
          <button
            type="button"
        ...
        <span
          ...
          className="inline-flex items-center py-1 px-2 mr-2 text-sm font-medium text-green-800 bg-green-100 rounded dark:bg-green-200 dark:text-green-800"
        >
          Green
          <button
            type="button"
        ...
        <span
          ...
          className="inline-flex items-center py-1 px-2 mr-2 text-sm font-medium text-yellow-800 bg-yellow-100 rounded dark:bg-yellow-200 dark:text-yellow-800"
        >
          Yellow
          <button
            type="button"
        ...
        <span
          ...
          className="inline-flex items-center py-1 px-2 mr-2 text-sm font-medium text-indigo-800 bg-indigo-100 rounded dark:bg-indigo-200 dark:text-indigo-800"
        >
          Indigo
          <button
            type="button"
            className="inline-flex items-center p-0.5 ml-2 text-sm text-indigo-400 bg-transparent rounded-sm hover:bg-indigo-200 hover:text-indigo-900 dark:hover:bg-indigo-300 dark:hover:text-indigo-900"
        ...
        >
          ...
          <button
            type="button"
            className="inline-flex items-center p-0.5 ml-2 text-sm text-purple-400 bg-transparent rounded-sm hover:bg-purple-200 hover:text-purple-900 dark:hover:bg-purple-300 dark:hover:text-purple-900"
        ...
        <span
          ...
          className="inline-flex items-center py-1 px-2 mr-2 text-sm font-medium text-pink-800 bg-pink-100 rounded dark:bg-pink-200 dark:text-pink-800"
        >
          Pink
          <button
            type="button"
            className="inline-flex items-center p-0.5 ml-2 text-sm text-pink-400 bg-transparent rounded-sm hover:bg-pink-200 dark:hover:bg-pink-300 dark:hover:text-pink-900"
