...
const PartnerLogin = (props: LoginTypes) => {
    ...
    const handleSignUpForm = async (val: any) => {
        ...
        // const response = await dispatch(loginUser(val));
    ...
    return (
        <div className="min-h-screen flex items-center flex-col">
            ...
            <div className={"!h-[70vh] w-full bg-red-400 fixed top-0"} style={{ background: 'linear-gradient(45deg, black, transparent)' }}>

            </div>
            <div className={"w-full p-4 absolute bottom-0 bg-white"}>
...
export default reduxForm({ form: FORM_NAME })(PartnerLogin);
